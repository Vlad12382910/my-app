...
export default function MobileFilters({ onClose, filters, setFilters, onClear }) {
  const artists = [
    "Giovanni Battista Piranesi", "Vincent van Gogh", "Vasily Pukirev", 
    "Gerard van Honthorst", "Thomas Cole", "Anton Sminck van Pitloo",
    "Gustav Klimt", "Johannes Vermeer", "Sandro Botticelli", 
    "Leonardo da Vinci", "Rembrandt", "Claude Monet", 
    "Edvard Munch", "Salvador Dalí", "Grant Wood", 
    "René Magritte", "Pablo Picasso"
  ];

  const locations = [
    "Tivoli", "Paris", "Moscow", "Amsterdam", "New York", "Naples",
    "Saint-Rémy", "Vienna", "The Hague", "Florence", "Le Havre",
    "Oslo", "Giverny", "Figueres", "Iowa", "Brussels", "Madrid", "Milan"
  ];
